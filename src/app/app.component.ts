...
export class AppComponent {
    ...
    getBalanceById(email?: string) {
        this.matchService.getBalanceById(email ?? this.currentUser.email).subscribe((res) => {
    ...
    uploadProfileImage() {
        if (this.imageFile) {
            ...
            this.authService.uploadPhoto(this.currentUser.email, this.formData).subscribe((res) => {
                console.log(res);
            });
