...
export class MatchService {
    ...
    joinTournament(tournamentId: string, data: { email: string; name: string }): Observable<any> {
    ...
    updateRequest(tournamentId: string, requestId: string, accept: boolean): Observable<any> {
        return this.http.put(`/updateRequest/${tournamentId}/${requestId}/${accept}`);
    }
    ...
    updateCompleteStatus(id: string, history: boolean, matchId: string): Observable<any> {
