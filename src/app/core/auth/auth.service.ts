...
export class AuthService {
    ...
    getAccessToken(): string {
        return this.localStorageService.getLocalStorageData(LOCAL_STORAGE_CONSTANT.token);
    }
    ...
    setUserData(user: Partial<any>): void {
        this.localStorageService.setLocalStorageData(LOCAL_STORAGE_CONSTANT.user, user);
    }

    getUserData(): any {
        const userToken = this.localStorageService.getLocalStorageData(LOCAL_STORAGE_CONSTANT.user);
        return userToken;
    }
